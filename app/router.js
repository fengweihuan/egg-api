...
module.exports = app => {
  ...
  // list 增删改查
  router.post('/material/create', app.jwt, controller.list.create)
  router.get('/material/list', app.jwt, controller.list.list)
  router.delete('/material/:id', app.jwt, controller.list.delete)
  router.put('/material/:id', app.jwt, controller.list.update)
  // 文件上传
  ...
  router.post('/upload/:id', controller.upload.update)
